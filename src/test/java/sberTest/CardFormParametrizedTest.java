...
public class CardFormParametrizedTest extends Inits{

    @ParameterizedTest(name = "Проверка клиента: {0} {1} {2}")
    @CsvSource({"Александров,Александр,Александрович", "Николаев,Николай,Николаевич", "Антонов,Антон,Антонович"})
    void testForm(String lastName, String firstName, String middleName){
